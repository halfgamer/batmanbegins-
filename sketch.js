...
var mango1;
var world,boy,thunder1,thunder2,thunder3,thunder4,bat1,bat2,bat3,bat4,bat5,invi,invi2,moon;
var drops = [];
var fulldops=1000;
function preload(){
...
function setup() {
	...
	if(frameCount % 150 === 0){
        ...
        for(var i=0; i<fulldops; i++){
            drops.push(new createDrop(random(0,20000), random(0,2000)));
        }
